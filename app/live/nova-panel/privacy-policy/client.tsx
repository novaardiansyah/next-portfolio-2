...
const content = {
  id: {
    metadata: {
      title: "Kebijakan Privasi - Nova Panel",
      description: "Kebijakan privasi untuk Nova Panel - Bagaimana kami mengumpulkan, menggunakan, dan melindungi informasi Anda",
      keywords: ["Kebijakan Privasi", "Perlindungan Data", "Nova Panel"],
    },
    hero: {
    ...
    sections: {
      introduction: {
        title: "Pendahuluan",
        content: [
          "Kebijakan Privasi ini menjelaskan kebijakan dan prosedur kami mengenai pengumpulan, penggunaan, dan pengungkapan informasi Anda saat Anda menggunakan Layanan Nova Panel, dan menjelaskan hak privasi Anda serta bagaimana hukum melindungi Anda.",
      ...
      interpretation: {
        ...
        definitions: [
          ...
          { term: "Aplikasi", definition: "Mengacu pada Nova Panel, program perangkat lunak yang disediakan oleh Perusahaan." },
          { term: "Perusahaan", definition: "Mengacu pada Nova Panel, disebut sebagai \"Perusahaan\", \"Kami\", \"Kami\" atau \"Milik Kami\"." },
  ...
  en: {
    metadata: {
      title: "Privacy Policy - Nova Panel",
      description: "Privacy policy for Nova Panel - How we collect, use, and protect your information",
      keywords: ["Privacy Policy", "Data Protection", "Nova Panel"],
    },
    hero: {
    ...
    sections: {
      introduction: {
        title: "Introduction",
        content: [
          "This Privacy Policy describes Our policies and procedures on the collection, use, and disclosure of Your information when You use the Nova Panel Service, and explains Your privacy rights and how the law protects You.",
      ...
      interpretation: {
        ...
        definitions: [
          ...
          { term: "Application", definition: "Refers to Nova Panel, the software program provided by the Company." },
          { term: "Company", definition: "Refers to Nova Panel, referred to as either \"the Company\", \"We\", \"Us\" or \"Our\"." },
              ...
              <section className="scroll-mt-24" id="contact">
                ...
                <div className="space-y-3">
                  <p className="text-gray-600 dark:text-gray-300">
                    ...
                    <a
                      href={`mailto:${t.sections.contact.email}?subject=${language === 'id' ? 'Pertanyaan%20Tentang%20Kebijakan%20Privasi%20Nova%20Panel' : 'Question%20About%20Nova%20Panel%20Privacy%20Policy'}`}
                      target="_blank"
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    ...
                    <a
                      href={`https://api.whatsapp.com/send/?phone=6289506668480&text=${language === 'id' ? 'Hai+Nova%2C+saya+memiliki+pertanyaan+tentang+Kebijakan+Privasi+untuk+Nova+Panel.+Bisakah+Anda+memberikan+penjelasan+untuk+saya%3F' : 'Hi+Nova%2C+I+have+a+question+about+the+Privacy+Policy+for+Nova+Panel.+Could+you+please+clarify+some+details+for+me%3F'}&type=phone_number&app_absent=0`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300"
                    >
