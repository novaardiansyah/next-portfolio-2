            ...
            <div className="prose prose-gray dark:prose-invert max-w-none legal-document font-serif">
              ...
              <section className="mb-12 scroll-mt-24" id="interpretation">
                ...
                <div className="space-y-4">
                  {t.sections.interpretation.definitions.map((item, index) => (
              ...
              <section className="mb-12 scroll-mt-24" id="collecting">
                ...
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2 mb-6">
                  {t.sections.collecting.personalData.items.map((item, index) => (
                ...
                <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                  {t.sections.collecting.usageData.items.map((item, index) => (
                    <li key={index}>{item}</li>
                  ))}
                </ul>
              </section>
              ...
              <section className="mb-12 scroll-mt-24" id="rights">
                ...
                {t.sections.rights.content.map((paragraph, index) => (
                  <p key={index} className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4 text-justify">
                    {paragraph}
                  </p>
                ))}
              ...
              <section className="scroll-mt-24" id="contact">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    ...
                    <a
                      href={`https://api.whatsapp.com/send/?phone=6289506668480&text=${language === 'id' ? 'Hai+Nova%2C+saya+memiliki+pertanyaan+tentang+Kebijakan+Privasi+untuk+Nova+App.+Bisakah+Anda+memberikan+penjelasan+untuk+saya%3F' : 'Hi+Nova%2C+I+have+a+question+about+the+Privacy+Policy+for+Nova+App.+Could+you+please+clarify+some+details+for+me%3F'}&type=phone_number&app_absent=0`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300"
                    >
