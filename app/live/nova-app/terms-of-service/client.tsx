...
const content = {
  id: {
    ...
    hero: {
      ...
      description: "Syarat dan ketentuan ini mengatur penggunaan aplikasi Nova App dan layanan yang kami sediakan.",
      lastUpdated: "Terakhir diperbarui: 3 November 2025"
    },
    ...
    sections: {
      introduction: {
        title: "Pendahuluan",
        content: [
          "Selamat datang di Nova App. Syarat dan ketentuan ini mengatur penggunaan aplikasi keuangan pribadi kami dan layanan yang kami sediakan.",
          "Dengan mengakses dan menggunakan Nova App, Anda menerima dan setuju untuk terikat oleh syarat dan ketentuan ini. Jika Anda tidak setuju dengan syarat dan ketentuan ini, Anda tidak boleh menggunakan aplikasi kami."
        ]
      },
      acceptance: {
        title: "Penerimaan Syarat",
        content: "Dengan mengakses dan menggunakan NovaApp, Anda menerima dan setuju untuk terikat oleh syarat dan ketentuan ini. Jika Anda tidak setuju dengan syarat dan ketentuan ini, Anda tidak boleh menggunakan aplikasi kami."
      },
      service: {
        title: "Deskripsi Layanan",
        intro: "NovaApp adalah aplikasi manajemen keuangan pribadi yang membantu pengguna untuk:",
        features: [
          "Mencatat pendapatan dan pengeluaran",
          "Membuat dan mengelola anggaran",
          "Melihat laporan keuangan",
          "Menetapkan tujuan keuangan",
          "Melacak transaksi dan pembayaran"
        ]
      },
      obligations: {
        title: "Kewajiban Pengguna",
        intro: "Sebagai pengguna NovaApp, Anda setuju untuk:",
        obligations: [
      ...
      privacy: {
        ...
        content: "Kami mematuhi Kebijakan Privasi kami dalam pengumpulan, penggunaan, dan perlindungan data pribadi Anda. Dengan menggunakan NovaApp, Anda menyetujui pengumpulan dan penggunaan data Anda sesuai dengan kebijakan privasi kami."
      },
      intellectual: {
        title: "Hak Kekayaan Intelektual",
        content: "NovaApp dan seluruh kontennya, termasuk namun tidak terbatas pada perangkat lunak, teks, grafik, logo, dan ikon, dilindungi oleh hak cipta dan hukum kekayaan intelektual lainnya. Anda tidak boleh mereproduksi, mendistribusikan, atau membuat karya turunan dari aplikasi kami tanpa izin tertulis."
      },
      liability: {
        title: "Batasan Tanggung Jawab",
        content: "NovaApp disediakan \"sebagaimana adanya\" tanpa jaminan dalam bentuk apa pun. Kami tidak bertanggung jawab atas kerugian langsung, tidak langsung, insidental, atau konsekuensial yang timbul dari penggunaan aplikasi kami."
      },
      thirdparty: {
  ...
  en: {
    metadata: {
      title: "Terms of Service - Nova App",
      description: "Terms of service for Nova App - Rules for using the personal finance application",
      keywords: ["Terms of Service", "Terms of Use", "Nova App"],
    },
    hero: {
      title: "Terms of Service",
      subtitle: "For Nova App",
      description: "These terms and conditions govern the use of the Nova App application and the services we provide.",
      lastUpdated: "Last updated: November 3, 2025"
    },
    ...
    sections: {
      introduction: {
        title: "Introduction",
        content: [
          "Welcome to Nova App. These terms and conditions govern the use of our personal finance application and the services we provide.",
          "By accessing and using Nova App, you accept and agree to be bound by these terms and conditions. If you do not agree to these terms and conditions, you must not use our application."
        ]
      },
      acceptance: {
        title: "Acceptance of Terms",
        content: "By accessing and using NovaApp, you accept and agree to be bound by these terms and conditions. If you do not agree to these terms and conditions, you must not use our application."
      },
      service: {
        title: "Service Description",
        intro: "NovaApp is a personal finance management application that helps users to:",
        features: [
      ...
      obligations: {
        ...
        intro: "As a NovaApp user, you agree to:",
        obligations: [
      ...
      privacy: {
        ...
        content: "We comply with our Privacy Policy in the collection, use, and protection of your personal data. By using NovaApp, you consent to the collection and use of your data in accordance with our privacy policy."
      },
      intellectual: {
        title: "Intellectual Property Rights",
        content: "NovaApp and all its content, including but not limited to software, text, graphics, logos, and icons, are protected by copyright and other intellectual property laws. You may not reproduce, distribute, or create derivative works of our application without written permission."
      },
      liability: {
        title: "Limitation of Liability",
        content: "NovaApp is provided \"as is\" without any warranties of any kind. We are not liable for any direct, indirect, incidental, or consequential damages arising from the use of our application."
      },
      thirdparty: {
              ...
              <section className="scroll-mt-24" id="contact">
                ...
                <div className="space-y-3">
                  <p className="text-gray-600 dark:text-gray-300">
                    ...
                    <a
                      href={`mailto:${t.sections.contact.email}?subject=${language === 'id' ? 'Pertanyaan%20Tentang%20Syarat%20dan%20Ketentuan%20Nova%20App' : 'Question%20About%20Nova%20App%20Terms%20of%20Service'}`}
                      target="_blank"
